...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.DB_PASSWORD = os.getenv('DB_PASSWORD','local')
        self.database_name = os.getenv('DB_NAME','trivia_test')
        self.database_path = 'postgresql+psycopg2://{}:{}@{}/{}'.format('postgres',
                                                                        'local',
                                                                        'localhost:5432',
                                                                        self.database_name)
    ...
    def test_get_non_existing_catogries(self):
        res = self.client().get("/categories/90940")
        data =json.loads(res.data)
